...
export const DEVICE_EVENT_TYPES = ["voice-toggle", "key-diagnostic", "connection-change", "audio-status"];
export const DEVICE_EVENT_SOURCES = ["simulator", "global-shortcut", "desktop-input", "easyinput"];
