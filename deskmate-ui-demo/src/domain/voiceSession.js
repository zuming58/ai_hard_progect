export const VOICE_SESSION_STATES = ["idle", "recording", "transcribing", "outputting", "completed", "error"];

const ALLOWED_TRANSITIONS = {
  idle: new Set(["recording", "error"]),
  recording: new Set(["idle", "transcribing", "error"]),
  transcribing: new Set(["idle", "outputting", "completed", "error"]),
  outputting: new Set(["idle", "completed", "error"]),
  completed: new Set(["idle", "recording", "error"]),
  error: new Set(["idle", "recording", "transcribing"]),
};
